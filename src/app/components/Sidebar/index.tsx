        ...
        <div className={cx('flex mt-5 gap-[10px] mb-4', collapsed ? 'flex-col' : 'flex-row ')}>
          {!collapsed && (
            <Tooltip content={t('GitHub')}>
              <a href="https://github.com/khulnasoft-lab/chathub?utm_source=extension" target="_blank" rel="noreferrer">
          ...
          {!collapsed && (
            <Tooltip content={t('Feedback')}>
              <a href="https://github.com/khulnasoft-lab/chathub/issues" target="_blank" rel="noreferrer">
