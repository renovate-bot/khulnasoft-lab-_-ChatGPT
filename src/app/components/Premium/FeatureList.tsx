...
const FeatureList: FC<{ highlightFeature?: FeatureId }> = (props) => {
  ...
  const features: Feature[] = useMemo(() => {
    return [
      ...
      },
      {
        ...
        link: 'https://github.com/khulnasoft-lab/chatgpt/wiki/Web-Access',
      },
      {
      ...
      },
      {
        ...
        link: 'https://github.com/khulnasoft-lab/chatgpt/wiki/Access-from-Chrome-side-panel',
      },
      {
      ...
      {
        title: t('Support the development of ChatGPT'),
      },
    ]
  }, [t])
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {i18n.language === 'zh-CN' && (
        <span className="text-sm text-secondary-text">请注意：ChatGPT会员并不为您提供ChatGPT账号或API key</span>
      )}
    </div>
  )
}
